...
public:
    static Simulation::FabricConfiguration
        normalFabric6lowres,
        slopeFabricRestOnPlane,
        conitnuousNormalTestFabric,
        tshirt1000,
        agenthat579,
        sock482,
        dressv7khandsUpDrape,
        sphereFabric,
        normalFabric6;

    static Simulation::SceneConfiguration
        simpleScene,
        rotatingSphereScene,
        windScene,
        tshirtScene,
        ...
        sockScene,
        dressScene,
        continousNormalScene,
        slopeSimplifiedScene;

    static Simulation::TaskConfiguration
        demoSphere,
        demoTshirt,
        demoWInd,
        demoHat,
