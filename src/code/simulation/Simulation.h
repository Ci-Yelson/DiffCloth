...
public:
    ...
    Simulation(
        Vec3d center)
        : systemCenter(center), sphere5(Vec3d(0, 0, 0), 5, Vec3d(0.352, 0.554, 0.663)), veryBigSphere(Vec3d(0, 0, 0), 15, Vec3d(0.352, 0.554, 0.663)), bowl(Vec3d(0, 0.5, 0), 0.5, COLOR_GRAY50), slopeGoal(Vec3d(0, 0, 0), 2, COLOR_IBM_MAGENTA50), sockLeg(Vec3d(0, 0, 0), Vec3d(0.4, 1, -0.2).normalized(), 5, 4), rightLeg(Vec3d(0, 0, 0), Vec3d(0, 1, -0.3), 5, 4), leftLeg(Vec3d(0, 0, 0), Vec3d(0, 1, -0.3), 5, 4), leftUpperArm(Vec3d(0, 0, 0), 0.6, 2.2, Vec3d(0, 1, 0), Vec3d(-1, -0.2, 0)), rightUpperArm(Vec3d(0, 0, 0), 0.6, 2.2, Vec3d(0, 1, 0), Vec3d(1, -0.2, 0)), leftLowerArm(Vec3d(0, 0, 0), 0.6, 2, Vec3d(0, 1, 0), Vec3d(-1, -0.4, 0)), rightLowerArm(Vec3d(0, 0, 0), 0.6, 2, Vec3d(0, 1, 0), Vec3d(1, -0.4, 0)), body(Vec3d(0, 0, 0), 2, 3.3, Vec3d(0, 1, 0), Vec3d(0, 1, 0)), neck(Vec3d(0, 0, 0), 0.6, 0.5, Vec3d(0, 1, 0), Vec3d(0, 1, 0)), head(Vec3d(0, 0, 0), 1, 1.5, Vec3d(0, 1, 0), Vec3d(0, 1, 0)), sphere2(Vec3d(0, 0, 0), 2, Vec3d(0.352, 0.554, 0.663)), sphere_head(Vec3d(0, 0, 0), 2.1, COLOR_GRAY57), sphereForFixedPointRender(Vec3d(0, 0, 0), 0.07, Vec3d(0.5, 0.5, 0), 6), plane1(Vec3d(0, 0, 5), Vec3d(-10, 0, -4), Vec3d(10, 0, -4), COLOR_GRAY50), slope(Vec3d(0, -11, 10), Vec3d(-8, -1, -1), Vec3d(8, -1, -1), COLOR_GRAY50), printVerbose(true)
    {
    ...
    void rotatePointsAccordingToConfig(std::vector<Vec3d>& particleIn)
    {
        ...
        case Orientation::BACK: {
            std::printf("orientation down: rotate\n");
            particleIn = rotatePointsAroundCenter(particleIn, axisToRotation(Vec3d(0, 0, 1), Vec3d(1, 0, 0)) * axisToRotation(Vec3d(1, 0, 0), Vec3d(0, 0, -1)));
            break;
        }
