...
bool Plane::isInContact(const Vec3d& center_prim, const Vec3d& pos, const Vec3d& velocity, Vec3d& normal, double& dist,
    Vec3d& v_out)
{
...
bool Sphere::isInContact(const Vec3d& center_prim, const Vec3d& pos, const Vec3d& velocity, Vec3d& normal, double& dist,
    Vec3d& v_out)
{
...
bool Bowl::isInContact(const Vec3d& center_prim, const Vec3d& pos, const Vec3d& velocity, Vec3d& normal, double& dist,
    Vec3d& v_out)
{
...
LowerLeg::LowerLeg(Vec3d center, Vec3d axis, double legLength, double footLength)
    : Primitive(LOWER_LEG, center, true,
        COLOR_WOOD)
{
...
bool LowerLeg::isInContact(const Vec3d& center_prim, const Vec3d& pos, const Vec3d& velocity, Vec3d& normal, double& dist,
    Vec3d& v_out)
{
...
bool Foot::isInContact(const Vec3d& center_prim, const Vec3d& pos, const Vec3d& velocity, Vec3d& normal, double& dist,
    Vec3d& v_out)
{
    for (Primitive* p : primitives) {
        if (p->isInContact(center_prim + p->centerInit, pos, velocity, normal, dist, v_out))
